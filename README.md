...
比如我们有10个 Future 并行执行，我们想在所有的 Future 运行完毕之后，执行某些函数，是没法通过 Future 实现的。
...
[示例代码](./juc-base-demo/src/main/java/top/sharehome/demo13/Demo13_1.java)如下：
...
![image-20240303233845337](./assets/image-20240303233845337.png)
